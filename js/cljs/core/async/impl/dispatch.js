...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12762 = 0;while(true){
var m_12763 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12763 == null))
{} else
{m_12763.call(null);
if((count_12762 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12764 = (count_12762 + 1);
count_12762 = G__12764;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3396__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3396__auto__)
