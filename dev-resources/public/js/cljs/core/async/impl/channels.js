...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12768 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12768 = (function (val,box,meta12769){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12768.cljs$lang$type = true;
cljs.core.async.impl.channels.t12768.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12768";
cljs.core.async.impl.channels.t12768.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t12768");
});
cljs.core.async.impl.channels.t12768.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12768.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12770){var self__ = this;
var _12770__$1 = this;return self__.meta12769;
});
cljs.core.async.impl.channels.t12768.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12770,meta12769__$1){var self__ = this;
var _12770__$1 = this;return (new cljs.core.async.impl.channels.t12768(self__.val,self__.box,meta12769__$1));
});
cljs.core.async.impl.channels.__GT_t12768 = (function __GT_t12768(val__$1,box__$1,meta12769){return (new cljs.core.async.impl.channels.t12768(val__$1,box__$1,meta12769));
});
}
return (new cljs.core.async.impl.channels.t12768(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3973__auto__,writer__3974__auto__,opts__3975__auto__){return cljs.core._write.call(null,writer__3974__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_12771 = self__.takes.pop();if((taker_12771 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12771))
{var take_cb_12772 = cljs.core.async.impl.protocols.commit.call(null,taker_12771);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12772,taker_12771){
return (function (){return take_cb_12772.call(null,null);
});})(take_cb_12772,taker_12771))
);
} else
{}
{
...
{var put_cb = cljs.core.async.impl.protocols.commit.call(null,put_handler);var _ = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb,_,put_handler,val,putter){
